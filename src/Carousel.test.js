...
it("works when you click on the right arrow", function() {
  ...
  expect(screen.getByAltText("Photo by Richard Pasquarella on Unsplash")).toBeInTheDocument();
  expect(screen.queryByAltText("Photo by Pratik Patel on Unsplash")).not.toBeInTheDocument();
